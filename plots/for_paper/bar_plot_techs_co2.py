...
nice_scenario_names = {
    ...
    "policy_reg_deindustrial_co2": "Continued Decline + CO2 grid",
    "policy_reg_regain_co2": "Reindustrialization + CO2 grid"
}
...
plot_total_eu_production_by_tech_reversed(
    ...
    years=years,
    save_path="graphs/european_production_stacked_co2.png"
)
