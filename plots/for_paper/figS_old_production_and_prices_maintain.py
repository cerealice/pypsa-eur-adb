...
scenarios = ["policy_reg_deindustrial","policy_reg_maintain","policy_reg_regain"]

scenario_labels = {
    "policy_reg_deindustrial": "Gradual Deindustr",
    "policy_reg_maintain": "Maintain Prod",
...
plot_total_eu_production_by_tech_reversed(
    ...
    years=years,
    save_path="graphs/european_production_stacked_maintain.png"
)
...
for scenario in scenarios:
    for year in years[1:]:
        file_path = os.path.join(root_dir,"results_august", scenario, "networks", f"base_s_39___{year}.nc")
...
fig, axes = plt.subplots(1, len(commodities), figsize=(15, 6), sharex=True, sharey=False)
...
plt.tight_layout()
plt.savefig("./graphs/commodity_prices_maintain.png", dpi=300)
plt.show()

# %%

# Paths to your two plots
img_path_production = "graphs/european_production_stacked_maintain.png"
img_path_prices = "graphs/commodity_prices_maintain.png"
...
# Save combined image
combined_img.save("graphs/production_prices_maintain.png")
