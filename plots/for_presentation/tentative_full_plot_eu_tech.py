...
def plot_total_eu_production_by_tech_reversed(
    ...
    technologies,
    years,
    save_path="full_graphs/european_production_stacked.png"
):
    n_rows = len(technologies)
    n_cols = len(scenarios)
    fig, axes = plt.subplots(n_rows, n_cols, figsize=(3.5 * n_cols, 3.5 * n_rows), sharex=True)
    ...
    bar_width = 5  # full-width bars, no space between years
...
plot_total_eu_production_by_tech(
    networks=networks,
    scenarios=scenarios,
    nice_scenario_names=nice_scenario_names,
    technologies=technologies,
    years=years,
    save_path="full_graphs/european_production_climate.png"
)
...
plot_total_eu_production_by_tech(
    ...
    technologies=technologies,
    years=years,
    save_path="full_graphs/european_production_industry.png"
)
...
plot_total_eu_production_by_tech(
    ...
    technologies=technologies,
    years=years,
    save_path="full_graphs/european_production_relocation.png"
)
"""