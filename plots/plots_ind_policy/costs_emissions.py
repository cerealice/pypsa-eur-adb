...
data_dict = {
    label_cost: {"policy_eu_regain": {}, "policy_eu_deindustrial": {}},
    label_emissions: {"policy_eu_regain": {}, "policy_eu_deindustrial": {}},
}
...
for year in years:
    for scenario in scenarios:
        ...
        file_path = os.path.join(parent_dir, "results_4hseg", scenario, "networks", f"base_s_39___{year}.nc")
