...
# === CONFIGURATION ===
scenarios = [ "base_eu_regain","base_reg_regain"]  # <=== DEFINE SCENARIOS HERE
...
scenario_colors = {
    "base_eu_regain": "grey",
    "base_reg_regain": "black",
    "policy_eu_regain": "green",
    "policy_eu_deindustrial": "orange",
    "policy_reg_regain": "purple"
}
scenario_labels = {
    "base_eu_regain": "Relocation",
    "base_reg_regain": "No relocation"
}

data_dict = {
    "Annual system cost [b€/yr]": {"base_eu_regain": {}, "base_reg_regain": {}},
    "CO2 emissions [MtCO2/yr]": {"base_eu_regain": {}, "base_reg_regain": {}},
}
...
plt.tight_layout()
plt.savefig("./graphs/base_costs_emissions.png")
plt.show()